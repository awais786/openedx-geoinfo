...
"""
geoinfo documentation build configuration file.
...
VERSION = get_version('../geoinfo/geoinfo', '__init__.py')
...
#
html_theme_options = {
    "repository_url": "https://github.com/awais786/openedx-geoinfo",
...
def on_init(app):  # pylint: disable=unused-argument
    ...
    check_call([apidoc_path, '-o', docs_path, os.path.join(root_path, 'geoinfo'),
                os.path.join(root_path, 'geoinfo/migrations')])
