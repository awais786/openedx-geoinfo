...
VERSION = get_version('geoinfo', '__init__.py')
...
setup(
    ...
    entry_points={
        'lms.djangoapp': [
            "geoinfo = geoinfo.apps:GeoInfoConfig",
        ],
        'cms.djangoapp': [
            "geoinfo = geoinfo.apps:GeoInfoConfig",
        ],
